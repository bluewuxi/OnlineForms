...
- [ ] P3-01 Public projection data model hardening  
...
- [ ] P3-02 Projection synchronization reliability  
...
- [ ] P3-03 Public query performance optimization  
...
- [ ] P3-04 Light audit logging foundation  
...
- [ ] P3-06 Payment placeholder contract hardening  
...
- [ ] P3-07 Payments namespace stub robustness  
...
- [ ] P3-08 Phase 3 validation pack (tests + smoke + ops notes)  
