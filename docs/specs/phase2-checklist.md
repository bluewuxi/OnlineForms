...
Source: `docs/specs/onlineforms_mvp_spec.md` Phase 2
...
- [x] P2-01 Submission query APIs (org)  
...
- [x] P2-02 Submission detail + status update APIs  
...
- [x] P2-03 Submission review UI backend contract hardening  
...
- [x] P2-04 Asset upload ticket API  
...
- [x] P2-05 Asset metadata persistence and retrieval  
...
- [x] P2-06 Course/tenant image binding flow  
...
- [x] P2-07 Observability baseline dashboards + alarms  
...
- [x] P2-08 Phase 2 tests + smoke pack  
